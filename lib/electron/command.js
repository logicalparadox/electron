...
/**
 * ### .option (options, description, required)
 *
 * You may define optionsal and required options for
 * each command. The options expects a comma delimited
 * list of commands with an optional default value or
 * indicator for parameters surrouned by brackets. You may
 ...
 *       .option('-f, --file [build.js]', 'Save the build to this file.', true);
 *
